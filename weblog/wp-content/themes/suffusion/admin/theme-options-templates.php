...
$suffusion_templates_options = array(
	...
	array("name" => "The \"Page of Posts\" template",
		"desc" => "This template can be used to create a page of posts. This will follow the default sidebar layout for the theme. To control whether the 'Full content posts' should appear on the second/third pages etc, go to <em>Other Graphical Elements &rarr; Layout: Excerpt / List / Tile / Mosaic / Full</em>",
